...
hl.bind(mainMod .. " + SPACE", hl.dsp.exec_cmd("quickshell ipc call menu apps"), { desc = "Application menu" })
...
hl.bind(mainMod .. " + SHIFT + M", hl.dsp.exec_cmd('launch-webapp "https://chat.google.com/"'), { desc = "Chat" })
hl.bind(mainMod .. " + SHIFT + Y", hl.dsp.exec_cmd('launch-webapp "https://youtube.com/"'), { desc = "YouTube" })

-- [Clipboard]
hl.bind(mainMod .. " + SHIFT + V", hl.dsp.exec_cmd("quickshell ipc call clipboard toggle"), { desc = "Clipboard manager" })
